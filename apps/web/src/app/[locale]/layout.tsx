...
import { getSiteConfig } from "@/lib/theme"
...
import { ThemeInjector } from "@/components/theme"
...
export default async function RootLayout({ children, params }: LayoutProps) {
  ...
  // Load site configuration for theming
  const siteConfig = await getSiteConfig(locale)

  return (
    <html lang={locale} suppressHydrationWarning>
      <head>
        <ThemeInjector locale={locale} />
      </head>
      <body
        className={cn(
      ...
      >
        ...
        <ServerProviders params={params}>
          <ClientProviders locale={locale} siteConfig={siteConfig}>
