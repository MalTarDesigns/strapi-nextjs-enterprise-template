...
jest.mock("../components/utilities/StrapiCkEditorContent", () => {
  return function MockCkEditor() {
    return (
      <div data-testid="ck-editor-content">CK Editor Content Component</div>
    )
  }
})
...
describe("PageContentComponents", () => {
    ...
    expectedComponents.forEach((componentKey) => {
      ...
      expect(
        PageContentComponents[
          componentKey as keyof typeof PageContentComponents
        ]
      ).toBeDefined()
    })
  })
  ...
  it("should render newsletter form component", () => {
    const NewsletterFormComponent =
      PageContentComponents["forms.newsletter-form"]
  ...
  it("should render CK editor content component", () => {
    const CkEditorComponent =
      PageContentComponents["utilities.ck-editor-content"]
  ...
  describe("Component Categories", () => {
    it("should have utilities category components", () => {
      const utilityComponents = Object.keys(PageContentComponents).filter(
        (key) => key.startsWith("utilities.")
      )
    ...
    it("should have sections category components", () => {
      const sectionComponents = Object.keys(PageContentComponents).filter(
        (key) => key.startsWith("sections.")
      )
